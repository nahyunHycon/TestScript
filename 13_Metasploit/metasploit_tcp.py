...
def create_auto_rc_file(exploit_module, rhost, filename="tcp.rc"):
...
def main():
    ...
    rhost = "192.168.0.12"
    auto_rc_file = "/home/hyconsoft_rnd/Desktop/TestScript/13_Metasploit/result/tcp.rc"
    ...
    with open("/home/hyconsoft_rnd/Desktop/TestScript/13_Metasploit/result/output_tcp.log", "w") as stdout_file, open("/home/hyconsoft_rnd/Desktop/TestScript/13_Metasploit/result/error_tcp.log", "w") as stderr_file:
        try:
