...
def run_autoware_sros2():
    try:
        # 명령어를 실행할 셸 스크립트 작성
        command = (
            "source /home/hyconsoft_rnd/autoware_node/install/setup.bash;ros2 run sros2_pkg sros2_node --ros-args --enclave /talker_listener/talker & "
        )   
