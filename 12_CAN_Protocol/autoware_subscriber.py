...
def run_autoware_subscriber():
    try:
        ...
        command = (
            "source /home/hyconsoft_rnd/Autoware-tool-subscriber/install/setup.bash; /home/hyconsoft_rnd/Autoware-tool-subscriber/build/autoware_subscriber/autoware_subscriber &"
        )
        # 쉘 환경에서 명령 실행
