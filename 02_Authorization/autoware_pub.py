...
def run_autoware_pub():
    try:
        # 명령어를 실행할 셸 스크립트 작성
        command = (
            "source /home/hyconsoft_rnd/autoware_node/autoware_pubsub/install/setup.bash;ros2 run autoware_pubsub pub --ros-args --enclave /talker_listener/talker &"
        )
